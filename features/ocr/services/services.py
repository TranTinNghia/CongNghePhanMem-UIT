    ...
    def save_service_scd2(self, service_name: str, container_key: str, from_date: str, to_date: str, unit_price: int, tax_rate: int) -> bool:
        ...
        try:
            ...
            if existing_service:
                ...
                cursor.execute(
                    "INSERT INTO dbo.services (service_name, container_key, from_date, to_date, unit_price, tax_rate, start_time) VALUES (?, ?, ?, ?, ?, ?, ?)",
                    (service_name, container_key, from_date, to_date, unit_price, tax_rate, current_timestamp)
                )
            else:
                cursor.execute(
                    "INSERT INTO dbo.services (service_name, container_key, from_date, to_date, unit_price, tax_rate) VALUES (?, ?, ?, ?, ?, ?)",
